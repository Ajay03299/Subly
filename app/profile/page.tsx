...
export default function ProfilePage() {
  ...
  return (
    <div className="mx-auto min-h-screen max-w-4xl bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-800 px-4 py-10 sm:px-6 lg:px-8">
      {/* Header */}
